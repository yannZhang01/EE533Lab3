...
// /___/   /\     Timestamp : 01/30/2026 21:12:03
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family aspartan2e -w C:/Lab3/again/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   CB8CLE_MXILINX_dropfifo XLXI_7 (.C(clk), 
                                   .CE(XLXN_13), 
                                   .CLR(rst), 
                                   .D(XLXN_24[7:0]), 
                                   .L(XLXN_17), 
   ...
   COMP8_MXILINX_dropfifo XLXI_11 (.A(XLXN_19[7:0]), 
                                   .B(XLXN_18[7:0]), 
                                   .EQ(XLXN_31));
   // synthesis attribute HU_SET of XLXI_11 is "XLXI_11_20"
   COMP8_MXILINX_dropfifo XLXI_12 (.A(XLXN_18[7:0]), 
                                   .B(XLXN_24[7:0]), 
                                   .EQ(XLXN_32));
   // synthesis attribute HU_SET of XLXI_12 is "XLXI_12_21"
   AND3B2 XLXI_13 (.I0(XLXN_32), 
                   .I1(XLXN_31), 
                   .I2(fiforead), 
                   .O(XLXN_34));
   OR2 XLXI_14 (.I0(XLXN_3), 
                .I1(XLXN_4), 
                .O(XLXN_5));
   AND2B1 XLXI_15 (.I0(XLXN_17), 
                   .I1(XLXN_5), 
                   .O(XLXN_41));
   VCC XLXI_16 (.P(XLXN_36));
   reg9B XLXI_17 (.ce(XLXN_36), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_38[71:0]));
   dualpoartmem9B XLXI_18 (.addra(XLXN_19[7:0]), 
                           .addrb(XLXN_18[7:0]), 
                           .clka(clk), 
                           .clkb(clk), 
                           .dina(XLXN_38[71:0]), 
